...
\animategraphics[autoplay, loop]{12}{waiting-}{0}{11}
\end{figbox}
\newpage
%%%%%
\begin{tcolorbox}
...
\begin{figbox}
\centering
\scalebox{0.3}{\animategraphics[autoplay, loop]{24}{法陣}{0}{226}}
\end{figbox}
\newpage
%%%%%
\begin{tcolorbox}
...
\begin{figbox}
\centering
\scalebox{0.35}{\animategraphics[autoplay, loop]{24}{小人舞蹈}{0}{191}}
\end{figbox}
\newpage
%%%%%
\section{路途上的難處？}
